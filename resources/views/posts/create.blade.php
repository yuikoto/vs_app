    ...
    <div class="container lg:w-1/2 md:w-4/5 w-11/12 mx-auto mt-8 px-8 bg-white shadow-md">
        ...
        <form action="{{ route('posts.store') }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="mb-4">
                ...
                <input type="date" name="vaitel_date" required>
                <br>
                <label class="block text-gray-700 text-sm mb-2" for="vaitel_time">時間 ：
                </label>
                <input type="time" name="vaitel_time" required>
                <br>
                ...
                <label class="block text-gray-700 text-sm mb-2" for="vaitel_comment" name="vaitel_comment"
                    placeholder="コメント" rows="10" cols="60">
                </label>
                <textarea name="vaitel_comment" rows="10"
